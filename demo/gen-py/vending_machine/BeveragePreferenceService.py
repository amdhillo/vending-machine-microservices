...
class GetBeverage_args(object):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.btype = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.btype is not None:
            oprot.writeFieldBegin('btype', TType.STRING, 1)
            oprot.writeString(self.btype.encode('utf-8') if sys.version_info[0] == 2 else self.btype)
            oprot.writeFieldEnd()
...
GetBeverage_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'btype', 'UTF8', None, ),  # 1
)
